...
.plat{background: url('@/assets/images/recharge.png'); width: 190px; height: 60px;}
.plat-focus{background: url('@/assets/images/recharge-focus.png') no-repeat; position: absolute; top:0; left: 0;  width: 190px; height: 60px;}
